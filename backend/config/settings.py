...
MAIL_FLOW_OTP_RELAY_SECRET = os.getenv("MAIL_FLOW_OTP_RELAY_SECRET", "")
MAIL_FLOW_OTP_RELAY_TIMEOUT = float(os.getenv("MAIL_FLOW_OTP_RELAY_TIMEOUT", "10"))
MAIL_FLOW_LEADHUNT_RELAY_URL = os.getenv("MAIL_FLOW_LEADHUNT_RELAY_URL", "")
MAIL_FLOW_LEADHUNT_RELAY_SECRET = os.getenv(
    "MAIL_FLOW_LEADHUNT_RELAY_SECRET",
    os.getenv("MAIL_FLOW_OTP_RELAY_SECRET", ""),
)
MAIL_FLOW_SMTP_TEST_RELAY_URL = os.getenv("MAIL_FLOW_SMTP_TEST_RELAY_URL", "")
MAIL_FLOW_SMTP_TEST_RELAY_SECRET = os.getenv(
    "MAIL_FLOW_SMTP_TEST_RELAY_SECRET",
    os.getenv("MAIL_FLOW_OTP_RELAY_SECRET", ""),
)
MAIL_FLOW_SMTP_TEST_RELAY_TIMEOUT = float(os.getenv("MAIL_FLOW_SMTP_TEST_RELAY_TIMEOUT", "25"))
