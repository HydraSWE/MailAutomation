...
const items = [
  ...
  ["/templates", "Templates", FileText, ["admin", "manager", "operator", "viewer"]],
  ["/recipients", "Recipients", Users, ["admin", "manager", "operator", "viewer"]],
  ["/campaigns", "Campaigns", Mail, ["admin", "manager", "operator", "viewer"]],
  ["/smtp", "Campaign SMTP", Server, ["owner", "admin", "manager", "operator", "viewer"]],
  ["/reports", "Reports", BarChart3, ["admin", "manager", "operator", "viewer"]],
